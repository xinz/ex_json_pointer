...
iex> ExJSONPointer.resolve(%{"a+b" => 1, "a b" => 2}, "#/a+b")
{:ok, 1}
```

URI fragment pointers follow URI fragment decoding semantics. For example, `+` remains `+` and is not treated as a space.
